...
/* Smarty version 4.3.0, created on 2023-08-09 11:20:57
  from 'C:\OSPanel\domains\stroiecoreshenie.ru\manager\templates\default\header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_64d34c6976eef8_88001770',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e18bcd80bd29e5531c1d1c0780d2fa080870be68' => 
    array (
      0 => 'C:\\OSPanel\\domains\\stroiecoreshenie.ru\\manager\\templates\\default\\header.tpl',
      1 => 1673927902,
      2 => 'file',
    ),
  ),
...
function content_64d34c6976eef8_88001770 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['_pagetitle']->value, ENT_QUOTES, 'UTF-8', true);?>
 | <?php }
echo htmlspecialchars((string)preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['_config']->value['site_name'] ?: ''), ENT_QUOTES, 'UTF-8', true);?>
</title>
        ...
        <div id="modx-navbar">
            <ul id="modx-headnav">
                <li id="modx-home-dashboard">
                    <a href="?" title="<?php echo htmlspecialchars((string)preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['_config']->value['site_name'] ?: ''), ENT_QUOTES, 'UTF-8', true);?>
">
...
/images/modx-icon-color.svg" title="<?php echo htmlspecialchars((string)preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['_config']->value['site_name'] ?: ''), ENT_QUOTES, 'UTF-8', true);?>
">
                    </a>
                </li>
                <li id="modx-site-info">
                    <div class="info-item full_appname"><?php echo htmlspecialchars((string)preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['_version']->value['full_version'] ?: ''), ENT_QUOTES, 'UTF-8', true);?>
</div>
                </li>
